...
class DisplaySavedAddressFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val toolbar =
            view.findViewById<androidx.appcompat.widget.Toolbar>(R.id.myCustomToolbarSavedAddress)
        ...
        buttonAddNewAddress.setOnClickListener {
            ...
            val action =
                DisplaySavedAddressFragmentDirections.actionDisplaySavedAddressFragmentToAdressFragment()
    ...
    companion object {
        ...
        @JvmStatic
        fun newInstance(param1: String, param2: String) = DisplaySavedAddressFragment().apply {
